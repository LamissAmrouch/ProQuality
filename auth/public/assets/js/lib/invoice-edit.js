...
/*var newRow ='<td class="amount"><a class="control removeRow" href="#">x</a><input id="questions[]" type="text"/></td><td class="amount"><input id="reponses[]" type="text"/></td><td class="amount"><input id="remarques[]" type="text"/></td>'; */
var newRow = '<tr> <input name="IdQ[]" type="hidden" value=""/> <td class="amount"><a class="control removeRow" href="#">x</a> <input name="questions[]" type="text" value=""/></td> <td class="amount"> <input name="reponses[]" type="text" value=""/></td> <td class="amount"><input name="remarques[]" type="text" value=""/></td> </tr>';
