<div class="header">
        ...
        <div class="pull-right p-r-15">
            <ul>
                        ...
                        <div class="dropdown-content-body">
                            <ul>
                                        ...
                                        <li>
                                            @if($notif->type!="Rappel") 
                                                <a href="{{ route('anomalie.createFrom',$notif->anomalie_id) }}"> 
                                                    <i class="pull-left m-r-10 avatar-img ti-alert"></i>
                                ...
                                <li class="text-center">
                                    <a href="{{ route('alertRF.list') }}" class="more-link">Voir Plus</a>
                                </li> 
                            </ul>
                        </div>
                    </div>
                ...
                <li class="header-icon dib">
                    <img class="avatar-img" src="{{ asset('public/assets/images/avatar/face16.jpg')}}" alt="" /> 
