                ...
                <div class="main-content">
                        <div class="card alert">
                                <div class="card-header">
                                    <div class="col-lg-6">
                                        <h4>Liste des alertes retours clients</h4>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="text-right">  
                                            @role('simple') 
                                                <a href="{{ route('alertRC.create')}}">
                                                    <button type="button" class="btn btn-primary btn-addon m-b-10 m-l-5">
                                                        <i class="ti-plus"></i>Ajouter un retour client</button>                 
                                                </a>
                                            @endrole
                                        </div>        
                                    </div>
                                        ...
                                        @foreach($alerts as $alert)
                                            ...
                                            @endrole>
                                                ...
                                                <td>
                                                    ...
                                                    <form method="POST" id="delete-form-{{$alert->id}}" action="{{ route('alertRC.delete',$alert) }}" style="display:none;">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete')}}
                                                    </form>
