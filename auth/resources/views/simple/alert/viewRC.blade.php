                ...
                <div class="col-lg-12 p-r-0 p-l-0">
                    <div class="card alert">
                        <div class="card-header">
                            <div class="col-lg-6">
                            <h4> {{ __('Consultation alerte retour client') }} </h4>
                            </div>

                            <div class="col-lg-6">
                                        <div class="text-right"> 
                                         @if(isset($alert))
                                                <a target="_blank" href="{{ route('alertRC.pdf',$alert)}}">
                                ...
                                <form  method="POST"> 
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input readonly="readonly" type="text" class="form-control" name="client"
                                                    @if(isset($alert))
                                                    value="{{ $alert->client->nom }}" 
                                                    @endif 
                                                    required>
                                            </div>
                                        </div>
