                        ...
                        <div class="basic-form">
                           <form action="{{ $actionForm }}" method="POST" >
                               {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label for="reference" class="text-right p-t-10 col-md-4">{{ __('Réference') }}</label>
                                        <div class="col-md-5">                                           
                                            ...
                                            <div class="text-right">   
                                                <button type="button" class="btn btn-info btn-addon m-t-10 m-b-10 m-l-5" 
                                                  data-toggle="modal" id="modal-toggle" data-target="#modalAddProcede">
                                                    <i class="ti-plus"></i>Ajouter un procédé</button>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="descriptionProc" class="form-control" rows="3" required>  
                        </textarea>                  
                    </div>
                </div>
            </div>
