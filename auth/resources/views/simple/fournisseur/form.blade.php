                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="{{ route('fournisseur.list')}}">Fournisseurs</a></li>
                                    <li class="active">                        
                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="description" class="form-control" rows="3">@if(isset($fournisseur)){{ $fournisseur->description }}@endif</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
