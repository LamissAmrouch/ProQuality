                ...
                <div class="row main-header">
                    <div class="col-lg-8 p-0">
                        <div class="page-header">
                            <div class="page-title"><h3>Statistiques retours production ( année : {{ $yearDisplayed }} )</h3></div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="{{ route('statistiques.retourProduction' , $yearDisplayed) }}">Retours par Type</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="dropdown" style="display: inline-block;">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="menu1" role="menu" style="height:500%; overflow:hidden; overflow-y:scroll;">
                                    ...
                                    <li role="presentation"><a role="menuitem" href="{{ route('statistiques.retourProduction',$year)}}">
                                        {{ $year }}
                                    </a></li>
                                    @endfor
                                </ul>
                ...
                <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card alert">
                                <div class="card-header m-b-10">
                                    <h4>Quantité de retour production par article </h4>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card alert">
                                <div class="card-header m-b-10">
                                    <h4>Quantité de retour production par atelier </h4>
                                </div>
                                <div class="card-body card-content">
