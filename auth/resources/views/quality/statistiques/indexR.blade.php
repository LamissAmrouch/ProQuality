            ...
            <div class="row main-header">
                ...
                <div class="col pull-right m-b-10 m-r-40">
                    <div class="row">
                        ...
                        <a role="button" class="btn btn-primary" href="{{ route('statistiques.article',$yearDisplayed)}}">
                            Filtrer par article
                        </a>
                        <div class="dropdown" style="display: inline-block">
                            <button id="menu2" class="btn btn-danger dropdown-toggle" type="button" data-toggle="dropdown"> Filtrer par type
                    ...
                    <div class="col-lg-12">
                        <div class="card alert">
                            <div class="card-header m-b-10">
                                <h4>Tableau récapitulatif des retours</h4>
                            </div>
