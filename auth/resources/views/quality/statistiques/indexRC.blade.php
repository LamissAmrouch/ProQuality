                ...
                <div class="row main-header">
                    <div class="col-lg-8 p-0">
                        <div class="page-header">
                            <div class="page-title"><h3>Statistiques retours client ( année : {{ $yearDisplayed }} )</h3></div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="{{ route('statistiques.retourClient' , $yearDisplayed) }}">Retours par Type</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card alert">
                                <div class="card-header m-b-10">
                                    <h4>Quantité de retour client par article</h4>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card alert">
                                <div class="card-header m-b-10">
                                    <h4>Quantité de retour client par client </h4>
                                </div>
                                <div class="card-body card-content">

                                        <div style="width: 90%;margin: 0 auto;">
                                        {!! $chartClient->container() !!}
                                        </div>
